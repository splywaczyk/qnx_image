...
| File | Purpose |
|------|---------|
| `00_common/apps/receiver/receiver.cpp` | Secure receiver with EACCES/EPERM handling |
| `00_common/apps/receiver/receiver.secpol` | Receiver security policy fragment |
| `00_common/apps/sender_a/sender_a.cpp` | Authorized sender (ALLOWED) |
| `00_common/apps/sender_a/sender_a.secpol` | Sender A security policy fragment |
| `00_common/apps/sender_b/sender_b.cpp` | Unauthorized sender (DENIED) |
| `00_common/apps/sender_b/sender_b.secpol` | Sender B security policy fragment |
| `secpol/BUILD` | Compiles modular policy fragments |
| `image_buildfiles/ipc_secure.build` | IFS with secpolpush enforcement |
...
2. Examine the modular security policy fragments:
   - `00_common/apps/receiver/receiver.secpol`
   - `00_common/apps/sender_a/sender_a.secpol`
   - `00_common/apps/sender_b/sender_b.secpol`
...
**Image not found**: Run `bazel build //03_ipc:ipc_secure_ifs` first
